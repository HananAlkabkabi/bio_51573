...
# add a positional argument, in this case, the position in the Slurm is jjob
parser.add_argument("job_name", help="Name of the Slurm job", type=str)

# add a poptional argument, time
parser.add_argument("-t", "--walltime", help="Walltime for the Slurm job")
